import java.io.*;
import java.util.*;
class Item {//a class named item is declared
  String name;
  int price;
...
public class Main {
  public static void main(String[] args) throws Exception {
    FileInputStream fis=new FileInputStream("input.txt");  //reads from input file     
    ...
    while(sc.hasNextLine())  //here names of googies are inserted into array
    {
    ...
    Collections.sort(goodies_items, new Comparator<Item>(){//here prices are compared 
    ...
    FileWriter fw = new FileWriter("output.txt");//output is written to the file
